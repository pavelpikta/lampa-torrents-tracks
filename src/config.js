...
const TORRSERVER_METADATA_MAX_ATTEMPTS = parseEnvPositiveInt('TORRSERVER_METADATA_MAX_ATTEMPTS', 60);
const TORRSERVER_METADATA_ATTEMPT_DELAY = parseEnvPositiveInt('TORRSERVER_METADATA_ATTEMPT_DELAY', 1000);
